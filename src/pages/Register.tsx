        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Enter your details to get started with VoyageX
            </CardDescription>
          </CardHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="email" placeholder="name@example.com" autoComplete="email" disabled={isLoading} {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="tel" placeholder="+1 (555) 123-4567" autoComplete="tel" disabled={isLoading} {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <CardFooter className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-4 w-full">
                  ...
                  <Button
                    ...
                    type="button"
                    disabled={isLoading}
                    onClick={() => toast.info('GitHub sign-in is not enabled yet.')}
                  >
